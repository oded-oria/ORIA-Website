...
|---|---|---|---|
| Home — default | 0 | 0 | 43 |
| Home — "High contrast" on | 0 | 0 | 43 |
| Home — "Larger text" on | 0 | 0 | 43 |
| Home — options panel open | 0 | 0 | 43 |
| Home — photo viewer open | 0 | 0 | 18 |
| Accessibility statement — default | 0 | 0 | 42 |
| Accessibility statement — "High contrast" on | 0 | 0 | 42 |
| Accessibility statement — "Larger text" on | 0 | 0 | 42 |
| Accessibility statement — options panel open | 0 | 0 | 42 |
...
| "Skip to main content" is the first focusable element | 2.4.1 | Pass |
...
| `lang="en"`; the Greek registration label marked `lang="el"` | 3.1.1, 3.1.2 | Pass |
...
## 5. Not covered by this assessment
